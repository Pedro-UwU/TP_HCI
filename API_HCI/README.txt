Instalación del API:
--------------------
1) Descomprimir el archivo "API v2.0.0 Installer.zip" en el directorio de instalación.
2) Descargar de https://nodejs.org/en/ la versión 14.16.1 o superior de node.js correspondiente a la plataforma.
...
2) Copiar el archivo "exercise.sqlite3" que se encuentra en el archivo "API v2.0.0 Installer.zip" a el subdirectorio "db" del directorio de instalación.